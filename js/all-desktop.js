...
$(document).ready(function (){
	...
	$("#dribbble-shots li").one("hover",function(){

		$views = $(this).find(".views");
		$likes = $(this).find(".likes");
					
		if(!$views.hasClass("animated")){
			...
			$views.addClass("animated");
		}

		if(!$likes.hasClass("animated")){
